...
if ( ! class_exists( 'SetsailSelectWelcomePage' ) ) {
	class SetsailSelectWelcomePage {
		/**
		 * singleton class
		 */
		...
		/**
		 * get the instance of SetsailWelcomePage
		 *
		 * @return self
		 */
		...
		function welcome_page_content() {
			...
			$params['theme_screenshot']  = file_exists( SELECT_ROOT_DIR . '/screenshot.png' ) ? SELECT_ROOT . '/screenshot.png' : SELECT_ROOT . '/screenshot.jpg';

			echo setsail_select_get_html_module_template_part( 'templates/welcome', 'welcome', '', $params );
		}
		...
		function enqueue_styles( $hook ) {
			if ( $hook === 'appearance_page_setsail_select_welcome_page' ) {
				wp_enqueue_style( 'setsail-select-welcome-page-style', SELECT_FRAMEWORK_MODULES_ROOT . '/welcome/assets/admin/css/welcome.min.css' );
			}
		}
	}
}

SetsailSelectWelcomePage::get_instance();