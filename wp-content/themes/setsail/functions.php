	...
	function setsail_select_back_to_top_button() {
		if ( setsail_select_options()->getOptionValue( 'show_back_button' ) == 'yes' ) { ?>
			<a id='qodef-back-to-top' href='#'>
                <span class="qodef-btt-text"><i class="fa fa-arrow-up"></i></span>
			</a>
		<?php }
	}
...
if( ! function_exists( 'setsail_select_add_registration_admin_notice' ) ) {
	function setsail_select_add_registration_admin_notice() {
			...
			<div class="error">
				<p>
					...
					echo wp_kses_post( sprintf(
						__( 'Your copy of the theme has not been activated. Please navigate to <a href="%s">SetSail Dashboard</a> where you can input your purchase code and activate your copy of the theme so you can have access to all the theme features, elements & options.', 'setsail' ),
						admin_url('admin.php?page=setsail_core_dashboard')
					) );
					?>
				</p>
			</div>
	...
	add_action('admin_notices', 'setsail_select_add_registration_admin_notice');
}