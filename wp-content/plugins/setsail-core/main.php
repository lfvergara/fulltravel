...
if ( ! function_exists( 'setsail_core_theme_menu' ) ) {
	...
	function setsail_core_theme_menu() {
		if ( setsail_core_theme_installed() && setsail_core_is_theme_registered() ) {
...
if ( ! function_exists( 'setsail_core_theme_admin_bar_menu_options' ) ) {
	...
	function setsail_core_theme_admin_bar_menu_options( $wp_admin_bar ) {
		if ( setsail_core_theme_installed() && current_user_can( 'administrator' ) && setsail_core_is_theme_registered() ) {
			global $setsail_select_global_Framework;
...
if( ! function_exists( 'setsail_core_is_theme_registered' ) ) {
	function setsail_core_is_theme_registered() {
		return class_exists('SetSailCoreDashboard') ? SetSailCoreDashboard::get_instance()->is_theme_registered() : true;
	}
}