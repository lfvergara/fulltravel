...
class SetSailInstagramApi {
	...
	const INSTAGRAM_CODE = 'setsail_instagram_code';
	const INSTAGRAM_USER_ID = 'setsail_instagram_user_id';
	const INSTAGRAM_TOKEN = 'setsail_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'setsail_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'setsail_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'setsail_facebook_code';
	const FACEBOOK_TOKEN = 'setsail_facebook_access_token';

	const CONNECTION_TYPE = 'setsail_connection_type';
	 ...
	 * @return stdClass
	 *
	 * @see SetSailInstagramApi::instagramExchangeCodeForToken()
	 */
